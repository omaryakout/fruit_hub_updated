  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          Positioned(
              top: 8, right: 8, child: Icon(Icons.favorite_border_outlined)),
          Positioned(
              top: 20,
              left: 16.5,
              right: 15.5,
              child:Image.network(productEntity.imageUrl,width: double.infinity,fit:BoxFit.fill ,)),
          Positioned(
            bottom: 16,
            left: 0,
            right: 0,
                ...
                TextSpan(
                    ...
                    children: [
                      TextSpan(
                          text: '/الكيلو  ',
                          style: AppTextStyle.bold13
                              .copyWith(color: AppColor.lightsecondrycolors)),
                    ]),
              ),
